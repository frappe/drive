<template>
  <div
    ...
    :class="
      activity.action_type === 'share_remove' ? 'strike-div text-ink-gray-4' : 'text-ink-gray-7'
    "
  >
    <Avatar
      size="xs"
  ...
  <div
    ...
    class="border max-w-[220px] rounded-[7px] px-1 py-1 gap-x-1 flex items-center justify-center overflow-clip text-sm"
    :class="
      activity.action_type === 'share_remove' ? 'strike-div text-ink-gray-3' : 'text-ink-gray-8'
    "
  >
    <GeneralAccess
      size="sm"
