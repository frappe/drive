<script>
import ApplicationCompress from './ApplicationCompress.vue'
import ApplicationJavascript from './ApplicationJavascript.vue'
import ApplicationJson from './ApplicationJson.vue'
...
import TextGo from './TextGo.vue'
import TextMarkdown from './TextMarkdown.vue'
import TextXPython from './TextXPython.vue'
