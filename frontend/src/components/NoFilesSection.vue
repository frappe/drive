<template>
  <div
    class="flex h-full w-full flex-col items-center justify-center rounded-lg bg-neutral-50 text-center"
  >
    <svg
      viewBox="0 0 78 85"
    ...
    <p class="text-2xl font-semibold">{{ primaryMessage }}</p>
    <p class="text-base">{{ secondaryMessage }}</p>
  </div>
</template>
<script>
export default {
